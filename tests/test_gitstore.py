...
from annals.config import ArchiveConfig, Config, GitConfig, SourceConfig
from annals.gitstore import commit_and_maybe_push, ensure_repo
...
def test_commit_when_dirty(tmp_path: Path):
    ...
    cfg = Config(
        ...
        git=GitConfig(author_name="annals", author_email="sk@example.com"),
